...
const DB_NAME = `mongodump --uri ${process.env.mongoUrl}`;

const ARCHIVE_PATH = path.join(__dirname, 'backup', `${'d'}.gzip`);
...
cron.schedule('0 0 */3 * *', () => backupMongoDB());

function backupMongoDB() {
  const child = spawn('mongodump', [
    '--uri=mongodb+srv://wasimrz:wasim9505@cluster0.hom8u.mongodb.net/chatapp-dev',
